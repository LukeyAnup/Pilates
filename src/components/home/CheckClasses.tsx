...
export default function CheckClasses() {
  ...
  return (
    <div>
      <section className="bg-white hidden md:flex py-12 px-4 flex-col text-center mt-12">
        {fields.title && (
          <div className="mb-8">
            <h2 className="text-3xl font-bold mb-2">{fields.title}</h2>
          </div>
        )}
        ...
        <div className="mb-8 md:mb-2">
          <h2 className="text-2xl font-bold mb-2">{fields.title3}</h2>
